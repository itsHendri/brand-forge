...
**Semantics** — the 71 tokens below. Every one aliases a primitive, and
...
| light | `#c7d2df` | `--inverse-muted-foreground`, `--inverse-border` |
...
| dark | `#556575` | `--surface-overlay`, `--inverse-muted-foreground` |
